...
<summary>View</summary>  
```{r, echo = FALSE, eval = TRUE, message = FALSE}
GRanges.dtf <- GRanges.gnr |> as.data.frame() |> head(n=3L)
GRanges.dtf <- GRanges.dtf[,-c(4)]
knitr::kable(GRanges.dtf[,c(1:4,6,5)],
  col.names = c(
    "seq","start","end","strand",
    "name","score"),
  align  = "rccccc",
...
<summary>View</summary>  
```{r, echo = FALSE, eval = TRUE, message = FALSE}
Tad.dtf <- Tad.gnr |> as.data.frame() |> head(n=3L)
Tad.dtf <- Tad.dtf[,-c(4)]
knitr::kable(Tad.dtf[,c(1:4,7,5,6)],
  col.names = c(
    "seq","start","end","strand",
    "name","score","class"),
  align  = "rcccccc"
...
<summary>View</summary>
```{r, echo = FALSE, eval = TRUE, message = FALSE}
Tss.dtf <- Tss.gnr |> as.data.frame() |> head(n=3L)
Tss.dtf <- Tss.dtf[,-c(4)] 
knitr::kable(Tss.dtf[,c(1:4,6,5)],
  col.names = c(
    "seq","start","end","strand",
    "name","class"),
  align  = "rccccc"
...
```{r, eval = TRUE}
TssNoBeaf.ndx <- SuperTK::NotIn(Tss.gnr_ndx$bin,Beaf.gnr_ndx$bin)
...
Beaf_VS_TssNoBeaf.dtf <- Beaf_VS_TssNoBeaf.gni |>
  as.data.frame() |>
  head(n=3L)
Beaf_VS_TssNoBeaf.dtf <- Beaf_VS_TssNoBeaf.dtf[,-c(4,5,9,10)]
Beaf_VS_TssNoBeaf.dtf[,c(1:11,13,12,17,16,18,15,14,20,19,21)] |>
  knitr::kable(
    col.names = c(
      "seq","start","end",
      "seq","start","end",
  ...
  kableExtra::add_header_above(c("Ranges" = 6 , "Metadata"=15))
```
</details>
...
<summary>View</summary>  
```{r, eval = TRUE, echo = FALSE}
tad_Border.dtf <- tad_Border.gnr |>
  as.data.frame() |>
  head(n=3L)
tad_Border.dtf <- tad_Border.dtf[,-c(4)]
knitr::kable(tad_Border.dtf[,c(1:4,7,5,6)],
  col.names = c(
    "seq","start","end","strand",
    "name","score", "class"),
  align  = "rcccccc"
...
<summary>View</summary>  
```{r, eval = TRUE, echo = FALSE}
tad_Border.dtf <- GenomicRanges::reduce(tad_Border.gnr) |> as.data.frame() |> head(n=3L)
knitr::kable(tad_Border.dtf[,-c(4)],
  col.names = c(
    "seq","start","end","strand"),
  align  = "rcccc"
  ) 
...
<summary>View</summary>  
```{r, eval = TRUE, echo = FALSE}
tad_Border_Binnned.dtf <- tad_Border_Binnned.gnr |>
  as.data.frame() |>
  head(n=3L)
tad_Border_Binnned.dtf <- tad_Border_Binnned.dtf[,-c(4)]
knitr::kable(tad_Border_Binnned.dtf[,c(1:4,7,5,6)],
  col.names = c(
    "seq","start","end","strand",
    "name","score", "class"),
  align  = "rcccccc"
...
tad_Border_Binnned.dtf <- tad_Border_Binnned.gnr |>
  ...
  head(n=3L)
tad_Border_Binnned.dtf <- tad_Border_Binnned.dtf[,-c(4)]
knitr::kable(tad_Border_Binnned.dtf[,c(1:4,7,5,6,8,9)],
  col.names = c(
    "seq","start","end","strand",
...
<summary>View</summary>  
```{r, eval = TRUE, echo = FALSE}
tad_Border_Binnned.dtf <- tad_Border_Binnned.gni |>
  as.data.frame() |>
  head(n=3L)
tad_Border_Binnned.dtf <- tad_Border_Binnned.dtf[,-c(4,5,9,10)]
tad_Border_Binnned.dtf[,c(1,2,3,9,7,8,10,11,4,5,6,14,13,12,15,16)] |>
  knitr::kable(
    col.names = c(
...
```{r, eval = FALSE}
names(S4Vectors::mcols(attributes(Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst)$interactions))
```
Here a look of 
```{r, eval = FALSE}
...
<summary>View</summary>  
```{r, eval = TRUE, echo = FALSE}
Interactions_Regions_Beaf_VS_TssNoBeaf_ctrl.dtf <- attributes(Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst)$interactions |>
  as.data.frame() |>
  head(n=10L)
Interactions_Regions_Beaf_VS_TssNoBeaf_ctrl.dtf <- Interactions_Regions_Beaf_VS_TssNoBeaf_ctrl.dtf[,-c(4,5,9,10)]
Interactions_Regions_Beaf_VS_TssNoBeaf_ctrl.dtf[,c(1:11,13,12,17,16,18,15,14,20,19,21)] |>
  knitr::kable(
    col.names = c(
      "seq","start","end",
      "seq","start","end",
...
attributes(first100_Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst)$interactions
```
A selection of some matrices remove attributes.
```{r, eval = TRUE}
attributes(Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst[1:20])$interactions
```
...
```{r, eval = TRUE}
attributes(first100_Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst)$interactions$orientation[13:14] 
```
...
```{r, eval = FALSE}
first100_Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst[[13]][1:5,1:5]
```
...
```{r, eval = FALSE}
oriented_first100_Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst[[13]][1:5,1:5]
```
...
```{r, eval = FALSE}
first100_Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst[[14]][1:5,1:5]
```
...
```{r, eval = FALSE}
oriented_first100_Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst[[14]][97:101,97:101]
```
...
```{r, eval = FALSE}
OrienteMatrix(first100_Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst[[13]])[97:101,97:101]
```
...
```{r, eval = FALSE}
OrienteMatrix(first100_Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst[[14]])[97:101,97:101]
```
...
```{r, eval = TRUE, echo = FALSE}
S4Vectors::mcols(attributes(oriented_first100_Regions_Beaf_VS_TssNoBeaf_ctrl.mtx_lst)$interactions)[45:50,c("name","anchor.Beaf.name")] |>
  `row.names<-`(45:50) |>
...
```{r, eval = TRUE}
diffAggreg[5,5]
mean(unlist(beafKdQuantif.num) - unlist(rawQuantif.num))
```            
...
mean(unlist(beafKdQuantif.num)) - mean(unlist(rawQuantif.num))
```
...
mean(unlist(beafKdQuantif.num)) + correctedFact.num
```
...
mean(unlist(beafKdQuantif.num)) - mean(unlist(rawQuantif.num)) + correctedFact.num
```
# Aggregations plots
